...
export const CareerMapLogo = () => (
  <Link href="/feed" className="flex-shrink-0 flex items-center space-x-2">
    ...
    >
      ...
      {/* Abstract path suggesting a career/road */}
      <path 
...
// Optional dark mode version if needed
// export const CareerMapLogoDark = () => (
//   <Link href="/feed" className="flex-shrink-0 flex items-center space-x-2">
//     <svg 
//       viewBox="0 0 24 24" 
...
//       <span className="text-xl font-extrabold text-white">Map</span>
//       <div className="w-1.5 h-1.5 rounded-full bg-white ml-0.5 animate-pulse"/>
//     </div>
//   </Link>
// );